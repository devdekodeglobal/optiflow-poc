    ...
    <div style={{
      ...
      <div className="card animate-in" style={{
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 28, margin: '0 0 8px', color: 'var(--primary)', fontWeight: 800 }}>Centre For Sight</h1>
          <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: 14 }}>OptiFlow Proof of Concept</p>
        </div>
