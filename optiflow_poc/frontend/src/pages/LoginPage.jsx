    ...
    <div style={{
      ...
      <div className="card animate-in" style={{
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: 28, margin: '0 0 4px', color: 'var(--primary)', fontWeight: 900, fontFamily: '"Montserrat", sans-serif', textTransform: 'uppercase', letterSpacing: '1px' }}>CENTRE FOR SIGHT</h1>
