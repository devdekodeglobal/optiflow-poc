  ...
  return (
    <div onClick={() => { setPrintMenuOpen(false); setExportMenuOpen(false); }}>
      ...
      <div className="print-only" style={{ display: 'none', marginBottom: 30, textAlign: 'center' }}>
        <h1 style={{ margin: 0, fontSize: 24, fontWeight: 900, color: 'black', fontFamily: '"Montserrat", sans-serif', textTransform: 'uppercase', letterSpacing: '1px' }}>CENTER FOR SIGHT</h1>
