    ...
    <div className="layout-content">
      <div className="header-actions animate-in">
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <button className="btn btn-secondary" onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL}/api/allocation/download/region/${encodeURIComponent(detail.region_name)}`}>
            ⬇ Download Region CSV
          </button>
        </div>
      </div>
