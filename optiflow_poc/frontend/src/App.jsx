      ...
      <div className="app-layout">
        <aside className={`sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
          ...
          <div className="sidebar-brand" style={{ textAlign: sidebarCollapsed ? 'center' : 'left' }}>
            <h1 style={{ fontSize: '18px', lineHeight: '1.2', fontFamily: '"Montserrat", sans-serif', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '-0.5px', transform: 'scaleX(0.95)', transformOrigin: sidebarCollapsed ? 'center' : 'left' }}>{!sidebarCollapsed && 'National Eyewear Company'}</h1>
