...
p1 = r'const CollapsibleRow = \(\{ node.*?\};\n\nexport default function DispatchPage\(\) \{'
content = re.sub(p1, "import AllocationDrillDown from '../components/AllocationDrillDown';\n\nexport default function DispatchPage() {", content, flags=re.DOTALL)
...
with open(file_path, "w") as f:
    f.write(content)
print("Patched DispatchPage.jsx")
